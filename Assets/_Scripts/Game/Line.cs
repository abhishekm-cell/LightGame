...
public class Line : MonoBehaviour
{
    ...
    private int smoothingIterations = 2;   // You can increase to 3 or 4 for extra smoothness
...
[SerializeField] private LineRenderer _renderer;
    ...
    private bool CanAppend(Vector2 pos)
    {
        ...
        return Vector2.Distance(_renderer.GetPosition(_renderer.positionCount - 1), pos) > DrawManager.Resolution; // _renderer.positionCount - 1 = last pos
    }
*/
